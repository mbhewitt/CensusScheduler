...
CREATE TABLE `op_volunteer_shifts` (
  ...
  `add_shift` int NOT NULL DEFAULT '0',
  `delete_shift` int NOT NULL DEFAULT '0',
  `update_shift` int NOT NULL DEFAULT '0',
...
CREATE TABLE `op_volunteers` (
  ...
  `new_account` int NOT NULL DEFAULT '0',
  `needs_update` int NOT NULL DEFAULT '0',
...
CREATE TABLE `op_shifts` (
  ...
  `start_time_lt` varchar(16) CHARACTER SET latin1 DEFAULT NULL,
  `end_time_lt` varchar(16) CHARACTER SET latin1 DEFAULT NULL,
