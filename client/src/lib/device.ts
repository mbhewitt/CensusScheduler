...
// once it holds a valid `peers-device` cookie, set by /api/provision/claim
...
// same network / playa internet — can passcode-login. See migration 012.
//
...
const COOKIE_NAME = "peers-device";
