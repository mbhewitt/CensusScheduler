...
export const Help = () => {
  ...
  // External links (Burner Profile, Discord) are dead on the offline on-playa
  // build; OfflineLink handles that per-link by offering to email them (#643,
  // #630), so no page-level on-playa branch is needed here.
  return (
    <>
      <Hero
        imageStyles={{
